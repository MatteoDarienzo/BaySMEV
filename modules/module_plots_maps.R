...
################################################################################
  ...
  #^****************************************************************************
  #^* IN
  #^*    1.  [list of lists] tmp_array --> list object with maps to grid
  #^*    2.  [1d array] lon_tmp --> longitude grid.
  #^*    3.  [1d array] lat_tmp --> latitude grid.
  #^*    4.  [sf,tbl] mask_shp  --> userdefined shapefile as mask for the land.
  #^*    5.  [sf,tbl] mask_world  --> world shapefile.
  #^*    6.  [character] path_output --> path of output files.
  #^*    7.  [CRS] crs_map --> Coordinate system for the map, ex: WGS84
  #^*    8.  [character] title_x  --> ex: "Longitude (°E)",
  #^*    9.  [character] title_y  --> ex: "Latitude (°N)",
  #^*    10. [array of reals] breaks_x  -->breaks x,ex:c(6.00001,10,14,18),
  #^*    11. [array of reals] breaks_y  -->breaks y,ex:c(36.00001,40,44,47.9999),
  #^*    12. [character] labels_x  -->labels x,ex:c("6°E","10°E","14°E","18°E"),
  #^*    13. [character] labels_y  -->labels y,ex:c("36°N","40°N","44°N","48°N"),
  #^*    14. [array of reals] limits_x  --> longitude lim of map,ex:c(6,19),
  #^*    15. [array of reals] limits_y  --> latitude lim of map,ex:c(36,48).
  #^* OUT
  #^*    1. save map with indeces.
  #^****************************************************************************
  #^* REF.:
  #^****************************************************************************
  #^* to do: 
  ...
  #^* COMMENTS: 
  ##############################################################################
  # initialize map ggplot main settings:
  base_ggplot=ggplot()+theme_bw()+
  ...
  map_indexes=base_ggplot+
    ...
    coord_sf(xlim=limits_x,ylim=limits_y,expand=F)+
...
plot_map_quantiles <- function(plotlist, title, pathout){
  ...
  #^****************************************************************************
  #^* IN
  #^*    1. [list of lists] plotlist --> list object with maps to grid
  #^*    2. [character] title --> title of plot
  #^*    3. [character] pathout --> path of output figure 
  #^* OUT
  #^*    1. 
  #^****************************************************************************
  #^* REF.:
...
################################################################################
  ...
  #^* IN
  #^*    1. [list of lists] plotlist --> list object with maps to grid
  #^*    2. [character] title -->  title of the output figure
  #^*    3. [character] pathout --> path of output figure 
  #^* OUT
  #^*    1. 
  #^****************************************************************************
  ...
  all.plots=plot_grid(plotlist[[1]]+theme(legend.title=element_blank()),#+theme(legend.position="none"),
                      ...
                      label_size=20,labels=c("1h","3h","6h","24h"),
...
plot_maps_param=function(var_list      = list(),
                         ...
                         flag.saveRDS  = F){
################################################################################
  #^* GOAL: compute and save map of model parameters for different durations
  #^****************************************************************************
  #^* PROGRAMMER: Matteo Darienzo, University of Padua, Italy
  #^****************************************************************************
  #^* CREATED/MODIFIED: 2025/11/28
  #^****************************************************************************
  #^* IN
  #^*    1.  [list of lists] var_list --> list object with SMEV/GEV parameters
  #^*    2.  [1d array] lon_tmp --> longitude grid.
  #^*    3.  [1d array] lat_tmp --> latitude grid.
  #^*    4.  [array of int] durations --> ex: c(60,180,360,1440), # in minutes!
  #^*    5.  [sf,tbl] mask_shp  --> userdefined shapefile as mask for the land.
  #^*    6.  [sf,tbl] mask_world  --> world shapefile.
  #^*    7.  [logical] flag_signif --> flag to plot or not the signif pixels.
  #^*    8.  [list of lists] significance --> results of significance from tests
  #^*    9.  [character] name_var  --> ex: "Shape intercept".
  #^*    10. [character] type_estimate --> ex: "MaxPost",
  #^*    11. [character] name_model --> ex: "SMEV Nonstationary",
  #^*    12. [character] acronym_model --> ex: "ns",
  #^*    13. [character] path_output  --> ex: "/map_test",
  #^*    14. [array of reals] limits --> lower and upper limits to the map values
  #^*    15. [logical] flag.limits  --> flag to apply limit to map values or not.
  #^*    16. [list of lists] scale_grad --> color gradient for the map, ex: ="turbo"
  #^*    17. [CRS] crs_map --> coordinate system for the map, ex: WGS84
  #^*    18. [character] title_x  --> ex: "Longitude (°E)",
  #^*    19. [character] title_y  --> ex: "Latitude (°N)",
  #^*    20. [array of reals] breaks_x  --> breaks for x axis, ex: c(6.00001,10,14,18),
  #^*    21. [array of reals] breaks_y  --> breaks for y axis, ex: c(36.00001,40,44,47.9999),
  #^*    22. [character] labels_x  --> labels for x axis, ex: c("6°E","10°E","14°E","18°E"),
  #^*    23. [character] labels_y  --> labels for y axis, ex:c("36°N","40°N","44°N","48°N"),
  #^*    24. [array of reals] limits_x  --> longitude limits of the map , ex: c(6,19),
  #^*    25. [array of reals] limits_y  --> latitude limits of the map , ex: c(36,48)
  #^*    26. [real] alpha_shpworld  --> transparency of world country shp lines, ex:0.2,
  #^*    27. [real] size_points --> size of black points of signifcant trend, ex: 0.7
  #^*    28. [logical] flag.saveRDS --> save plots into .rds file
  #^* OUT
  #^*    1. [list of lists] --> map_var_LAND_allvar  (map with only land pixels)
  #^*                           map_var_ALLPIX_allvar (map with all pixels)
  #^*                           map_var_LAND_allvar_horiz 
  #^*                           map_var_ALLPIX_allvar_horiz
  #^****************************************************************************
  #^* REF.:
  #^****************************************************************************
  #^* to do: 
  ...
  # a few settings for plot legend:
  nbin=20
  ...
  #^****************************************************************************
    ...
    #^**************************************************************************
      # create dataframe for the map plot (round at 3rd decimal):
      a_w_MAP_df<-data.frame(x=round(lon_tmp,3), 
                             y=round(lat_tmp,3),
                             z=round(var_list[[v]][[dur]],3))
      ...
      #^                   ALL PIXELS (land & sea) 
      #^************************************************************************
      map_a_w_MAP=base_ggplot+
        geom_tile(data=a_w_MAP_df_NEW,aes(x=x,y=y,fill=z),alpha=1) + 
        geom_sf(data=mask_world,fill=NA,color="grey70") +
        geom_sf(data=test,colour="black",fill=NA,alpha=alpha_shpworld)+
        coord_sf(xlim=limits_x,ylim=limits_y,expand=F)
      
        if (flag_signif){
          #^************
          # 2do: implement the significance from likelihood ratio test
          # for fmins MLE method !!!
          #^************
          
          map_a_w_MAP=map_a_w_MAP+
          # geom_point(data=signif_AMAX_pos_df,aes(x=x,y=y,size=d),
          #            fill="blue",color="blue",shape=24)+
          # geom_point(data=signif_AMAX_neg_df,aes(x=x,y=y,size=d),
          #            fill="red",color="red",shape=25)+
          # geom_point(data=signif_ns_DIC_df_1,aes(x=x,y=y,size=z),
          #            fill="gray90",color="gray90",shape=21,size=0.7)+
          #geom_point(data=signif_ns_DIC_df,
          #           aes(x=x,y=y,size=z),shape=1,size=1)
          geom_point(data=signif_ns_DIC_df_3,aes(x=x,y=y,size=z),
                     fill="black",color="black",shape=21,size=size_points)
        }
        map_a_w_MAP=map_a_w_MAP+
        theme(
           panel.grid.major=element_blank()
      ...
      # ggsave(map_a_w_MAP,
      #        filename=paste0(dir_results,"/",folder_name,"/map_a_w_MAP",".png"),
      ...
      rast_a_w_MAP_nonan=rasterFromXYZ(a_w_MAP_df_nonan_NEW, 
                                       crs=crs_map)
      ...
      test_spdf<-as(r3,"SpatialPixelsDataFrame")
      test_df<-as.data.frame(test_spdf)
      rast_signif_DIC3_LAND=rasterFromXYZ(signif_ns_DIC_df_3, 
                                          crs=crs_map) 
      ## crop and mask (only LAND extent):
      ...
      if (flag.limits){
        if (scale_grad[[v]]$name=="turbo"){
          ...
          scale_fill_gradient2(low=scale_grad[[v]]$low,
                               ...
                               breaks=seq(limits[[v]][1],limits[[v]][2],limits[[v]][3]),
                               labels=seq(limits[[v]][1],limits[[v]][2],limits[[v]][3]),
                               guide=guide_colourbar(nbin=nbin,raster=T,
                                                     display="rectangles",
                                                     direction=bar.direction,
                                                     barwidth=barwidth, #grid::unit(0.6,"npc"),
                                                     barheight=barheight, #grid::unit(1,"npc"),#-grid::unit(,"line"),#40,
      ...
      # ggsave(map_a_w_MAP_LAND,
      #        filename=paste0(dir_results,"/",folder_name,"/map_a_w_MAP_LAND_",".png"),
      #        width= 15,height=15,dpi=200)
      # map_a_w_MAP_LAND
    ...
    title_ALLPIX=cowplot::ggdraw()+draw_label(paste0(name2print[1],'\n ',name2print[2]), 
                              fontface='bold',x=0.5,hjust=0.5,vjust=0.5,size=26)
      ...
      plotlist=list(title_ALLPIX,
                    ...
                    map_var_ALLPIX[[4]]+
                      ...
                      theme(legend.title=element_blank(), 
                            ...
                            axis.title=element_blank(),
                            plot.title=element_text(face="bold",hjust=0.5,size=26))),
      label_size=23,labels=NULL,ncol=5,nrow=1,
      rel_widths=c(0.5,1,1,1,1),align='hv')
    # all.plots_vardur:
    ...
    legend_LAND<-cowplot::get_plot_component(map_var_LAND[[1]]+
                                      theme(legend.title=element_blank(),
                                            plot.margin=margin(t=0,r=0,b=0,l=0)),
                                            'guide-box-right',return_all=T)
    title_LAND=cowplot::ggdraw()+
      draw_label(paste0(name2print[1],'\n ',name2print[2]),fontface='bold', 
                 x=0.5,hjust=0.5,vjust=0.5,size=26)
    # title_LAND=plot_grid(cowplot::ggdraw()+
    #                      draw_label(paste0(name2print[1],'\n ',name2print[2]), 
    #                                fontface='bold',x=0.5,hjust=0.5,vjust=3,size=26),
    #                      legend,labels=NULL,ncol=1,nrow=2,align='h')
  ...
  out=list(map_var_LAND_allvar         = map_var_LAND_allvar,
  ...
  if (flag.saveRDS){
    # save plot into .rds file
    saveRDS(out,file=paste0(dirname(path_output[v]),'/', 
                     basename(dirname(path_output[v])),'_maps.rds'))
  }
...
plot_maps_changes_amax2yrs=function(
               ...
               flag.saveRDS  = F){
################################################################################
  #^* GOAL: compute and save map of decadal changes in SMEV/GEV model parameters,
  #^*       AMAX and 2 yrs quantiles at different durations.
  #^****************************************************************************
  #^* PROGRAMMER: Matteo Darienzo, University of Padua, Italy
  #^****************************************************************************
  #^* CREATED/MODIFIED: 2025/11/28
  #^****************************************************************************
  #^* IN
  #^*    1.  [list of lists] var_change_list --> list object with the variables
  #^*                                            (decadal changes %) to plot.
  #^*    2.  [1d array] lon_tmp --> longitude grid
  #^*    3.  [1d array] lat_tmp --> latitude grid
  #^*    4.  [[array of int] durations --> ex: c(60,180,360,1440), # in minutes
  #^*    5.  [sf,tbl] mask_shp  --> userdefined shapefile as mask for the land
  #^*    6.  [sf,tbl] mask_world  --> world shapefile
  #^*    7.  [logical] flag_signif --> flag to plot stat significant pixels
  #^*    8.  [list of lists] significance --> results of signicance from tests
  #^*    9.  [character] sat_acron --> acronym of studied dataset,ex:'CMORPH'.
  #^*    10. [character] period --> string with period for title '2001-2024'.
  #^*    11. [integer] year_ref --> reference year for the changes, ex: 2013 
  #^*    12. [integer] year_ref_id --> index of rthe eference year, ex: 12
  #^*    13. [character] name_file_txt --> output txt filename with signicance
  #^*                                      results: paste0('signif_pixels.txt'),
  #^*    14. [character] path_output  --> ex: "/map_test",
  #^*    15. [array of reals] limits --> define lower/upper limits to the values
  #^*    16. [logical] flag.limits  --> flag to apply limits to map values.
  #^*    17. [list of lists] scale_grad --> color gradient for map, ex:="turbo"
  #^*    18. [CRS] crs_map --> coordinate system for the map, ex: WGS84
  #^*    19. title_x  --> ex: "Longitude (°E)",
  #^*    20. title_y  --> ex: "Latitude (°N)",
  #^*    21. [array of reals] breaks_x -->breaks x, ex:c(6.00001,10,14,18),
  #^*    22. [array of reals] breaks_y -->breaks y, ex:c(36.00001,40,44,47.9999),
  #^*    23. labels_x  --> labels for x axis, ex: c("6°E","10°E","14°E","18°E"),
  #^*    24. labels_y  --> labels for y axis, ex:c("36°N","40°N","44°N","48°N"),
  #^*    25. [array of reals] limits_x  -->longitude lim of map, ex: c(6,19),
  #^*    26. [array of reals] limits_y  -->latitude lim of map, ex: c(36,48)
  #^*    27. alpha_shpworld  --> transparency of world country shp lines, ex:0.2,
  #^*    28. size_points --> size of black points of signifcant trend, ex: 0.7
  #^*    29. [logical] flag.saveRDS --> save plots into .rds file
  #^* OUT
  #^*    1.
  #^****************************************************************************
  #^* REF.:
  ...
  for (dur in 1:4){
    ...
    rast_a_w_MAP=rasterFromXYZ(a_w_MAP_df_NEW, 
                               crs=crs_map)
    # increasing AMAX
    signif_AMAX_pos_df<-data.frame(x=lon_tmp,
                                   y=lat_tmp, 
    ...
    total_pixels=length(a_w_MAP_df$z)
    percent_signif_AMAX[[dur]]=pixels_signif_AMAX[[dur]]/total_pixels*100
    print(paste0("pixels with signif. trend in AMAX (WHOLE) = ",
                 pixels_signif_AMAX[[dur]]," / ",total_pixels," (",
                 round(percent_signif_AMAX[[dur]],1),"%)"))
    cat(paste0("pixels with signif. trend in AMAX (WHOLE) = ",
               pixels_signif_AMAX[[dur]]," / ",total_pixels," (",
               round(percent_signif_AMAX[[dur]],1),"%)"), 
        file=paste0(dir.res_maps_amax_qnt,name_file_txt),sep="\n",append=T)
    
    AMAXchange=base_ggplot+
      geom_tile(data=a_w_MAP_df_NEW, aes(x=x,y=y,fill=z),alpha=1)+ 
    ...
    if (flag_signif){
      AMAXchange=AMAXchange+
        # geom_point(data=signif_n_pos_df,aes(x=x,y=y,size=d),
        #            fill="blue",color="blue",shape=24)+
        # geom_point(data=signif_n_neg_df,aes(x=x,y=y,size=d),
        #            fill="red",color="red",shape=25)+
        # geom_point(data=signif_ns_DIC_df,
        #            aes(x=x,y=y,size=z),shape=1,size=1)+
        geom_point(data=signif_amax_df,aes(x=x,y=y,size=z),
                   fill="black",color="black",shape=21,size=size_points)
    }
    AMAXchange=AMAXchange+
      theme(
    ...
    test_spdf<-as(r3,"SpatialPixelsDataFrame")
    test_df<-as.data.frame(test_spdf)
    rast_signif_amax_LAND=rasterFromXYZ(signif_amax_df, 
                                        crs=crs_map) 
    ## crop and mask (only Italy extent):
    r=r2=r3=c()
    ...
    print(paste0("pixels with signif. trend in AMAX (LAND) = ", 
                 pixels_signif_AMAX_LAND[[dur]]," / ",total_pixels_LAND," (", 
                 round(percent_signif_AMAX_LAND[[dur]],1),"%)"))
    cat(paste0("pixels with signif. trend in AMAX (LAND) = ", 
               pixels_signif_AMAX_LAND[[dur]], 
               " / ",total_pixels_LAND," (",
               round(percent_signif_AMAX_LAND[[dur]],1),"%)"), 
        file=paste0(dir.res_maps_amax_qnt,name_file_txt),sep="\n",append=T)
    
    
    AMAXchange_LAND=base_ggplot+
      geom_tile(data=na.omit(test_df),aes(x=x,y=y,fill=z),alpha=1)+ 
      geom_sf(data=gg_world,fill=NA,color="grey70")+
      geom_sf(data=test,colour="black",fill=NA,alpha=0.2)+
      coord_sf(xlim=limits_x,ylim=limits_y,expand=F)
    ...
    print(paste0("pixels with signif. NS deltaDIC>=3 (WHOLE) = ",
                 pixels_signif_DIC3[[dur]]," / ",total_pixels," (",
                 round(percent_signif_DIC3[[dur]],1),"%)"))
    cat(paste0("pixels with signif. NS deltaDIC>=3 (WHOLE) = ",
               pixels_signif_DIC3[[dur]]," / ",total_pixels," (", 
               round(percent_signif_DIC3[[dur]],1),"%)"), 
        file=paste0(dir.res_maps_amax_qnt,name_file_txt),sep="\n",append=T)
    # compute percentage respect total amount of pixels:
    ...
    print(paste0("pixels with signif. NS deltaDIC>=1 (WHOLE) = ", 
                 pixels_signif_DIC1[[dur]]," / ",total_pixels," (", 
                 round(percent_signif_DIC1[[dur]],1),"%)"))
    cat(paste0("pixels with signif. NS deltaDIC>=1 (WHOLE) = ", 
               pixels_signif_DIC1[[dur]]," / ",total_pixels," (", 
               round(percent_signif_DIC1[[dur]],1),"%)"),
        file=paste0(dir.res_maps_amax_qnt,name_file_txt),sep="\n",append=T)
    
    
    twoyrchange=base_ggplot+
      geom_tile(data=a_w_MAP_df_NEW,aes(x=x,y=y,fill=z),alpha=1)+
    ...
    if (flag_signif){
      twoyrchange=twoyrchange+
        ...
        # geom_point(data=signif_ns_DIC_df_1,aes(x=x,y=y,size=z),
        #            fill="black",color="black",shape=21,size=0.7)+
        # geom_point(data=signif_ns_DIC_df,aes(x=x,y=y,size=z), 
        #            shape=1,size=1) +
        geom_point(data=signif_ns_DIC_df_3,aes(x=x,y=y,size=z), 
                   fill="black",color="black",shape=21,size=size_points)
    }
    ...
    test_spdf<-as(r3,"SpatialPixelsDataFrame")
    test_df_signif_DIC3<-as.data.frame(test_spdf)
    rast_signif_DIC1_LAND=rasterFromXYZ(signif_ns_DIC_df_1, 
                                        crs=crs_map) 
    ## crop and mask (only Italy extent):
    r=r2=r3=c()
    r=rast_signif_DIC1_LAND
    ...
    total_pixels=length(test_df$z)
    percent_signif_DIC3_LAND[[dur]]=pixels_signif_DIC3_LAND[[dur]]/total_pixels*100
    print(paste0("pixels with signif. NS deltaDIC>=3 (LAND) = ", 
                 pixels_signif_DIC3_LAND[[dur]]," / ",total_pixels," (", 
                 round(percent_signif_DIC3_LAND[[dur]],1),"%)"))
    cat(paste0("pixels with signif. NS deltaDIC>=3 (LAND) = ", 
               pixels_signif_DIC3_LAND[[dur]]," / ",total_pixels," (",
               round(percent_signif_DIC3_LAND[[dur]],1),"%)"),
        file=paste0(dir.res_maps_amax_qnt,name_file_txt),sep="\n",append=T)
    ...
    print(paste0("pixels with signif. NS deltaDIC>=1 (LAND) = ",
                 pixels_signif_DIC1_LAND[[dur]]," / ",total_pixels," (", 
                 round(percent_signif_DIC1_LAND[[dur]],1),"%)"))
    cat(paste0("pixels with signif. NS deltaDIC>=1 (LAND) = ", 
               pixels_signif_DIC1_LAND[[dur]]," / ",total_pixels," (",
               round(percent_signif_DIC1_LAND[[dur]],1),"%)"),
        file=paste0(dir.res_maps_amax_qnt,name_file_txt),sep="\n",append=T)
    
    
    twoyrchange_LAND=base_ggplot+
      geom_tile(data=na.omit(test_df),aes(x=x,y=y,fill=z),alpha=1)+
      geom_sf(data=gg_world,fill=NA,color="grey70")+#,linewidth=0.5) +
      geom_sf(data=test,colour="black",fill=NA,alpha=0.2)+#,linewidth=0.5)+
      coord_sf(xlim=limits_x,ylim=limits_y,expand=F)
    ...
    scalechange=base_ggplot+
      geom_tile(data=a_w_MAP_df_NEW,aes(x=x,y=y,fill=z),alpha=1)+
      geom_sf(data=gg_world,fill=NA,color="grey70")+#,linewidth=0.5) +
      geom_sf(data=test,colour="black",fill=NA,alpha=0.2)+#,linewidth=0.5)+ 
      # geom_point(data =df_NEW_SIGNIF_EU,aes(x=x,y=y,size=z), 
      #            fill="black",shape=19,size=1)+ #pixels with signif.nonstat.
      coord_sf(xlim=limits_x,ylim=limits_y,expand=F)
    if (flag_signif){
    ...
    shape_change=var_change_list$b_w_MAP_ns[[dur]]*10/
          (var_change_list$a_w_MAP_ns[[dur]]+
             var_change_list$b_w_MAP_ns[[dur]]*year_ref_id)*100
    # create dataframe for the map plot:
    a_w_MAP_df<-data.frame(x=lon_tmp, 
                           y=lat_tmp, 
                           z=shape_change)
    ...
    print(paste0("pixels with signif. trend in n (WHOLE) = ",
                 pixels_signif_n[[dur]]," / ",total_pixels," (",
                 round(percent_signif_n[[dur]],1),"%)"))
    cat(paste0("pixels with signif. trend in n (WHOLE) = ",
               pixels_signif_n[[dur]]," / ",total_pixels," (",
               round(percent_signif_n[[dur]],1),"%)"), 
        file=paste0(dir.res_maps_amax_qnt,name_file_txt),sep="\n",append=T)
    ...
    if (flag_signif){
      nchange=nchange+
        geom_point(data=signif_n_df,aes(x=x,y=y,size=z),
                   fill="black",color="black",shape=21,size=size_points)
        # geom_point(data=signif_ns_DIC_df_3,aes(x=x,y=y,size=z),   
    ...
    test_spdf<-as(r3,"SpatialPixelsDataFrame")
    test_df<-as.data.frame(test_spdf)
    rast_signif_n_LAND=rasterFromXYZ(signif_n_df,
                                     crs=crs_map) 
    ## crop and mask (only Italy extent):
    r=r2=r3=c()
    ...
    print(paste0("pixels with signif. trend in n (LAND) = ",
                 pixels_signif_n_LAND[[dur]]," / ", total_pixels," (",
                 round(percent_signif_n_LAND[[dur]],1),"%)"))
    cat(paste0("pixels with signif. trend in n (LAND) = ",
               pixels_signif_n_LAND[[dur]]," / ",total_pixels," (",
               round(percent_signif_n_LAND[[dur]],1),"%)"), 
        file=paste0(dir.res_maps_amax_qnt,name_file_txt),sep="\n",append=T)
    
    
    nchange_LAND=base_ggplot+
      geom_tile(data=na.omit(test_df),aes(x=x, y=y,fill=z),alpha=1)+ 
      geom_sf(data=gg_world,fill=NA,color="grey70")+#,linewidth=0.5) +
      geom_sf(data=test,colour="black",fill=NA,alpha=0.2)+#,linewidth=0.5)+
      coord_sf(xlim=limits_x,ylim=limits_y,expand=F)
    ...
    all.titles = plot_grid(title0,title1,title2,title3,title4,title5,
                           labels=NULL,ncol=1,nrow=6,
                           rel_heights=c(0.2,1,1,1,1,1),align='hv')
    ...
    # merge final plot:
    all.plots=plot_grid(
         ggdraw()+draw_label(sat_acron,fontface='bold',x=0.5,hjust=0.5,vjust=0.5,size=25),
         ...
         nchange     + theme(legend.title=element_blank(), 
                             ...
                             axis.title=element_blank()),
         # label_size=20,
         labels=NULL,ncol=1,nrow=6,rel_heights=c(0.2,1,1,1,1,1),
         align='hv')
    
    all.all.plots=plot_grid(
      all.titles,
      all.plots, #+theme(plot.title=element_text(size=20,hjust=0.5))+ggtitle(paste0(sat_acron,'\n')),
      label_size=20,labels=NULL,ncol=2,nrow=1,
      rel_widths=c(0.15,1),align='hv',hjust=-0.5,label_x=0)
    ggsave(all.all.plots, 
           filename=paste0(dir.res_maps_amax_qnt,
                           'all_maps_',sat_prod,'_',durations[dur]/60,'h.png'),
    ...
    if (flag.saveRDS){
      ...
      saveRDS(list(AMAXchange           = AMAX_change[[dur]],
            ...
            file=paste0(dir.res_maps_amax_qnt,
                        'all_maps_',sat_prod,'_',durations[dur]/60,'h.rds'))
    }
  ...
  if (flag.saveRDS){
    # Save lists of significant pixels into .rds R file:
...
################################################################################
  ...
  #^****************************************************************************
  #^* IN
  #^*    1.  [list of lists] var_unc_change_list --> list object with variables
  ...
  #^*                                      results: paste0('signif_pixels.txt'),
  #^*    14. [character] path_output  --> ex: "/map_test",
  #^*    15. [list of arrays] limits --> lower,upper limits to the map values
  #^*                                    for each variable/map.
  #^*    16. [logical] flag.limits --> flag to limit map values or not.
  #^*    17. [CRS] crs_map --> coordinate system for the map, ex:WGS84.
  #^*    18. [integer] nbin --> colorbar number of classes, ex:20.
  #^*    19. [character] bar.direction --> colorbar direction, ex:"horizontal".
  #^*    20. [character] legend.position --> colorbar position, ex:"bottom".
  #^*    21. [real] barwidth --> colorbar width, ex:25.
  #^*    22. [real] barheight --> colorbar height, ex:0.6.
  #^*    23. [character] title_x  --> x title, ex:"Longitude (°E)".
  #^*    24. [character] title_y  --> y title, ex:"Latitude (°N)".
  #^*    25. [array of reals] breaks_x -->breaks x,ex:c(6.00001,10,14,18),
  #^*    26. [array of reals] breaks_y -->breaks y,ex:c(36.00001,40,44,47.9999),
  #^*    27. [character] labels_x -->labels x,ex:c("6°E","10°E","14°E","18°E"),
  #^*    28. [character] labels_y -->labels y,ex:c("36°N","40°N","44°N","48°N"),
  #^*    29. limits_x  --> longitude limits of the map,ex:c(6,19),
  #^*    30. limits_y  --> latitude limits of the map,ex:c(36,48)
  #^*    31. alpha_shpworld  --> transparency of world country shp lines,ex:0.2,
  #^*    32. size_points --> size of black points of signifcant trend,ex:0.7
  #^*    33. [logical] flag.saveRDS --> save plots into .rds file
  #^* OUT
  #^*    1. [list of lists] --> 
  #^****************************************************************************
  #^* REF.:
  ...
  ##############################################################################
    ...
    ############################################################################
    #               Uncertainty in changes of 2yrs quantile:
    ############################################################################
    flag_signif   = T
    flag.limits   = T
    scale_grad    = list(name="rdbl",low="red",high="blue",mid="white",midpoint=0)
    ...
    twoyrchange_UNCERT=base_ggplot+
      geom_tile(data=a_w_MAP_df_NEW,aes(x=x,y=y,fill=z),alpha=1) + 
      geom_sf(data=gg_world,fill=NA,color="grey70")+ #,linewidth=0.5) +
      geom_sf(data=test,colour="black",fill=NA,alpha=0.2)+ #,linewidth=0.5)+
      coord_sf(xlim=limits_x, ylim=limits_y,expand=F)
    ...
    twoyrchange_UNCERT=twoyrchange_UNCERT+
      scale_fill_viridis(option="turbo",
                         ...
                         guide=guide_colourbar(nbin=nbin,
                                                ...
                                                direction=bar.direction,
                                                barwidth=barwidth, #grid::unit(0.6,"npc"),
                                                barheight=barheight, #grid::unit(1,"npc"),#-grid::unit(,"line"),
                                                frame.colour=c("NA"),
                                                frame.linewidth=1))
    ...
    twoyrchange_LAND_UNCERT=base_ggplot+
      geom_tile(data=na.omit(test_df),aes(x=x,y=y,fill=z),alpha=1)+ 
      geom_sf(data=gg_world,fill=NA,color="grey70")+ #,linewidth=0.5) +
      geom_sf(data=test,colour="black",fill=NA,alpha=0.2)+ #,linewidth=0.5)+
      coord_sf(xlim=limits_x, ylim=limits_y,expand=F)
    if (flag_signif){
      twoyrchange_LAND_UNCERT=twoyrchange_LAND_UNCERT+
        geom_point(data=test_df_signif_DIC3,aes(x=x,y=y,size=z),  
                   fill="black",color="black",shape=21,size=size_points)#0.4)
    }
    twoyrchange_LAND_UNCERT=twoyrchange_LAND_UNCERT+
      scale_fill_viridis(option="turbo",
                         limits=c(limits[[v]][1],limits[[v]][2]),
    ...
    ############################################################################
    #             Uncertainty in changes of "shape" parameter SMEV
    ############################################################################
    flag_signif   = T
    flag.limits   = T
    ...
    a_w_MAP_df<-data.frame(x=lon_tmp, 
                           y=lat_tmp, 
                           z=eval(parse(text=(paste0('unc_shape_',
                                                     durations[dur]/60,'h')))))
    # trend_df$z[is.na(trend_df$z)]=0
    if (sat_acron=='GSMAP'){
      a_w_MAP_df_NEW=a_w_MAP_df
    ...
    shapechange_UNCERT=base_ggplot+
      geom_tile(data=a_w_MAP_df_NEW, aes(x=x,y=y,fill=z),alpha=1)+ 
      geom_sf(data=gg_world,fill=NA,color="grey70")+ #,linewidth=0.5)+
      geom_sf(data=test,colour="black",fill=NA,alpha=0.2)+ #,linewidth=0.5)+
      coord_sf(xlim=limits_x,ylim=limits_y,expand=F)
    ...
    shapechange_LAND_UNCERT=base_ggplot+
      geom_tile(data=na.omit(test_df),aes(x=x,y=y,fill=z),alpha=1) + 
      geom_sf(data=gg_world,fill=NA, color="grey70")+ #,linewidth=0.5) +
      geom_sf(data=test,colour="black",fill=NA,alpha=0.2)+ #,linewidth=0.5)+
      coord_sf(xlim=limits_x,ylim=limits_y,expand=F)
    ...
    ############################################################################
    #             Uncertainty in changes of "scale" parameter SMEV 
    ############################################################################
    flag_signif   = T
    flag.limits   = T
    scale_grad    = list(list(name="rdbl",low="red",high="blue",mid="white",midpoint=0))
    ...
    scalechange_UNCERT=base_ggplot+
      geom_tile(data=a_w_MAP_df_NEW, aes(x=x,y=y,fill=z),alpha=1)+
      geom_sf(data=gg_world,fill=NA,color="grey70")+ #,linewidth=0.5)+
      geom_sf(data=test,colour="black",fill=NA,alpha=0.2)+ #,linewidth=0.5)+
      coord_sf(xlim=limits_x,ylim=limits_y,expand=F)
    ...
    scalechange_LAND_UNCERT=base_ggplot+
      geom_tile(data=na.omit(test_df),aes(x=x,y=y,fill=z),alpha=1) + 
      geom_sf(data=gg_world,fill=NA,color="grey70")+ #,linewidth=0.5)+
      geom_sf(data=test,colour="black",fill=NA,alpha=0.2)+ #,linewidth=0.5)+
      coord_sf(xlim=limits_x,ylim=limits_y,expand=F)
    ...
    all.titles=plot_grid(title0,title1,title2,title3,
                         labels=NULL,ncol=1,nrow=4,
                         rel_heights=c(0.25,1,1,1),align='hv')
    ...
    all.plots_LAND=plot_grid(
         ...
         scalechange_LAND_UNCERT+theme(legend.title=element_blank(), 
                                       ...
                                       axis.title=element_blank()),
         labels=NULL,ncol=1,nrow=4,
         rel_heights = c(0.2,1,1,1),align='hv')
    all.all.uncert.plots_LAND=plot_grid(  # create title object:
      ...
      label_size=22,labels=NULL,ncol=2,nrow=1,
      rel_widths=c(0.2,1),align='hv',hjust=-0.5,label_x=0)
...
################################################################################
# PLOT % changes of 2-20-50yrs quantiles (NONSTATIONARY SMEV MODEL)
################################################################################
plot_maps_changes_qnt=function(
                        ...
                        flag.saveRDS   = F){
  ##############################################################################
  #^* GOAL: compute and save map of decadal changes in quantiles at different 
  #^*       return periods (2,10,20,50) and different durations.
  #^****************************************************************************
  #^* PROGRAMMER: Matteo Darienzo, University of Padua, Italy
  #^****************************************************************************
  #^* CREATED/MODIFIED: 2025/11/28
  #^****************************************************************************
  #^* IN
  #^*    1.  [list of lists] var_qnt_change_list --> list object with quantiles
  #^*                                               changes in % (for different 
  #^*                                               return periods and durations.
  #^*    2.  [1d array] lon_tmp --> longitude grid
  #^*    3.  [1d array] lat_tmp --> latitude grid
  #^*    4.  [array of integers] durations --> ex:c(60,180,360,1440),in minutes
  #^*    5.  [sf,tbl] mask_shp  --> userdefined shapefile as mask for the land.
  #^*    6.  [sf,tbl] mask_world  --> world shapefile.
  #^*    7.  [logical] flag_signif --> flag to plot stat. significant pixels.
  #^*    8.  [list of lists] significance --> results of signicance from tests
  ...
  #^*    14. [character] path_output  --> ex: "/map_test",
  #^*    15. [list of arrays] limits --> lower/upper limits to the map values,
  #^*                                    one array for each map/quantile.
  #^*    16. limits_mean -->
  #^*    17. [logical] flag.limits  --> flag to limit map values or not.
  #^*    18. [list of lists] scale_grad --> color gradient for map,ex: "turbo"
  #^*    19. [CRS] crs_map --> coordinate system for the map, ex:WGS84
  #^*    20. [integer] nbin --> colorbar setting: number of classes, ex:20.
  #^*    21. [character] bar.direction --> colorbar direction, ex:"horizontal".
  #^*    22. [character] legend.position --> colorbar position, ex:"bottom".
  #^*    23. [real] barwidth --> colorbar width, ex:25.
  #^*    24. [real] --> colorbar height, ex:0.6.
  #^*    25  [integer] size_text_plot --> size font of text, ex:6
  #^*    26. [character] title_x  --> x title, ex:"Longitude (°E)".
  #^*    27. [character] title_y  --> y title, ex:"Latitude (°N)".
  #^*    28. breaks_x  --> breaks for x axis, ex: c(6.00001,10,14,18),
  #^*    29. breaks_y  --> breaks for y axis, ex: c(36.00001,40,44,47.9999),
  #^*    30. [character] labels_x  -->labels x,ex:c("6°E","10°E","14°E","18°E"),
  #^*    31. [character] labels_y  -->labels y,ex:c("36°N","40°N","44°N","48°N"),
  #^*    32. limits_x  --> longitude map lim,ex: c(6,19),
  #^*    33. limits_y  --> latitude map lim,ex: c(36,48)
  #^*    34. alpha_shpworld  --> transparency of world country shp lines,ex:0.2,
  #^*    35. size_points --> size of black points of signifcant trend, ex:0.7
  #^*    36. [logical] flag.saveRDS --> save plots into .rds file
  #^* OUT
  #^*    1.
  #^****************************************************************************
  #^* REF.:
  ...
  #^* to do: 
  #^****************************************************************************
  #^* COMMENTS: for now only 2, 10, 20, 50 yrs quantiles are considered. 
  #^*           Moreover, each quantile change map is computed separately in a 
  #^*           hardcoded way. Future versions must include a better and 
  #^*           possibly automatic cycle over user-defined quantiles. 
  ##############################################################################
  # initialize paths
  ...
  for (dur in 1:4){
    ...
    twoyrchange_LAND_mean=base_ggplot+
    ...
    # # Number of distinct raster values within the polygon
    # (coverage fractions are ignored)
    ...
    twoyrchange_LAND_mean_signif=base_ggplot+
      geom_sf(data=land_shp_NEW,colour="black",alpha=1)+
      geom_sf(data=test,aes(fill=z),colour="black",alpha=1)+
      # geom_point(data=test_df_signif_DIC3,aes(x=x,y=y,size=z),  
    ...
    tenyrchange_LAND_mean=base_ggplot+
      geom_sf(data=land_shp_NEW,colour="black",alpha=1)+
      geom_sf(data=test,aes(fill=z),colour="black",alpha=1)+
      geom_sf_text(
        data=test,aes(label=round(z,0)),
    ...
    tenyrchange_LAND_mean_signif=base_ggplot+
      geom_sf(data=land_shp_NEW, colour="black",alpha=1)+
      geom_sf(data=test,aes(fill=z),colour="black",alpha=1)+
      # geom_point(data=test_df_signif_DIC3,aes(x=x,y=y,size=z),  
      #            fill="black", color="black",shape=21,size=1)+
    ...
    twentyyrchange_LAND=base_ggplot+
      geom_tile(data=na.omit(test_df),aes(x=x,y=y,fill=z),alpha=1)+
      geom_sf(data=gg_world,fill=NA,color="grey70")+ #,linewidth=0.5)+
      geom_sf(data=test,colour="black",fill=NA,alpha=0.2)+ #,linewidth=0.5)+
      coord_sf(xlim=limits_x,ylim=limits_y,expand=F)
    ...
    twentyyrchange_LAND_mean=base_ggplot+
      geom_sf(data=land_shp_NEW,colour="black",alpha=1)+
      geom_sf(data=test,aes(fill=z),colour="black",alpha=1)+
      geom_sf_text(
        data=test,aes(label=round(z,0)),
    ...
    twentyyrchange_LAND_mean_signif=base_ggplot+
      geom_sf(data=land_shp_NEW, colour="black",alpha=1)+
      geom_sf(data=test,aes(fill=z),colour="black",alpha=1)+
      # geom_point(data=test_df_signif_DIC3,aes(x=x,y=y,size=z),  
      #            fill="black", color="black",shape=21,size=1)+
    ...
    fiftyyrchange_LAND=base_ggplot+
      geom_tile(data=na.omit(test_df),aes(x=x,y=y,fill=z),alpha=1)+ 
      geom_sf(data=gg_world,fill=NA,color="grey70")+ #,linewidth=0.5) +
      geom_sf(data=test,colour="black",fill=NA,alpha=0.2)+ #,linewidth=0.5)+
      coord_sf(xlim=limits_x,ylim=limits_y,expand=F)
    ...
    fiftyyrchange_LAND_mean=base_ggplot+
      geom_sf(data=land_shp_NEW,colour="black",alpha=1)+
      geom_sf(data=test,aes(fill=z),colour="black",alpha=1)+
      geom_sf_text(
        data=test,aes(label=round(z,0)),
    ...
    fiftyyrchange_LAND_mean_signif=base_ggplot+
      geom_sf(data=land_shp_NEW,colour="black",alpha=1)+
      geom_sf(data=test,aes(fill=z),colour="black",alpha=1)+
      # geom_point(data=test_df_signif_DIC3,aes(x=x,y=y,size=z),  
      #            fill="black", color="black",shape=21,size=1)+
    ...
    all.plots=plot_grid(
         ...
         fiftyyrchange+theme(legend.title=element_blank(), 
                             ...
                             axis.title=element_blank()),
         labels=NULL,
         ncol=1,nrow=5,rel_heights=c(0.2,1,1,1),align='hv')
    
    
    all.all.qnt.plots=plot_grid(
        all.titles,
        all.plots, # +theme(plot.title=element_text(size=20,hjust=0.5))+ggtitle("CMORPH\n"),
        label_size=25,labels=NULL,
        ncol=2,nrow=1,rel_widths=c(0.2,1),align='hv',hjust=-0.5,label_x=0)
    ...
    #^**************************************************************************
    all.plots_LAND_mean_signif=plot_grid(
       ggdraw()+draw_label(sat_acron,fontface='bold',x=0.5,hjust=0.5,vjust=0.5,size=20),
...
################################################################################
  ...
  #^****************************************************************************
  #^* IN
  #^*    1.  [list of lists] var_durat_change_list -->list object with variables
  ...
  #^*    5.  [sf,tbl] mask_shp  --> userdefined shapefile as mask for the land
  #^*    6.  [sf,tbl] mask_world  --> world shapefile
  #^*    7.  [sf,tbl] mask_user --> userdefined shapefile as mask for specific
  #^*                               areas where to compute aggregated statistics
  #^*    8.  [logical] flag_signif --> flag to plot stat significant pixels.
  #^*    9.  [list of lists] significance --> results of signicance from tests
  #^*    10.  [character] sat_acron --> acronym of studied dataset,ex:'CMORPH'.
  #^*    11. [character] period --> string with period for title '2001-2024'.
  #^*    12. [integer] year_ref --> reference year for the changes, ex: 2013 
  #^*    13. [integer] year_ref_id --> index of rthe eference year, ex: 12
  #^*    14. [character] path_output  --> ex: "/map_test",
  #^*    15. [list of arrays] limits --> lower,upper limits to the map values
  #^*                                    for each variable/map.
  #^*    16. [logical] flag.limits --> flag to limit map values or not.
  #^*    17. [CRS] crs_map --> coordinate system for the map, ex:WGS84.
  #^*    18. [character] title_x  --> x title, ex:"Longitude (°E)".
  #^*    19. [character] title_y  --> y title, ex:"Latitude (°N)".
  #^*    20. [array of reals] breaks_x -->breaks x,ex:c(6.00001,10,14,18),
  #^*    21. [array of reals] breaks_y -->breaks y,ex:c(36.00001,40,44,47.9999),
  #^*    22. [character] labels_x -->labels x,ex:c("6°E","10°E","14°E","18°E"),
  #^*    23. [character] labels_y -->labels y,ex:c("36°N","40°N","44°N","48°N"),
  #^*    24. limits_x  --> longitude limits of the map,ex:c(6,19),
  #^*    25. limits_y  --> latitude limits of the map,ex:c(36,48)
  #^*    26. alpha_shpworld  --> transparency of world country shp lines,ex:0.2,
  #^*    27. [logical] flag.saveRDS --> save plots into .rds file
  #^* OUT
  #^*    1. [list of lists] --> 
  #^****************************************************************************
  #^* REF.:
  ...
  for (dur in 1:4){
    ...
    scale_change=var_durat_change_list$b_C_MAP_ns[[dur]]*10/
      (var_durat_change_list$a_C_MAP_ns[[dur]]+
         var_durat_change_list$b_C_MAP_ns[[dur]]*year_ref_id)*100
    # create dataframe for the map plot:
    a_w_MAP_df<-data.frame(x=lon_tmp,
                           y=lat_tmp,
                           z=scale_change)
    ...
    shape_change=var_durat_change_list$b_w_MAP_ns[[dur]]*10/
      (var_durat_change_list$a_w_MAP_ns[[dur]]+
         var_durat_change_list$b_w_MAP_ns[[dur]]*year_ref_id)*100
    # create dataframe for the map plot:
    a_w_MAP_df<-data.frame(x=lon_tmp,
                           y=lat_tmp,
                           z=shape_change)
  ...
  for (z in 1:nrow(mask_user)){
    #^**************************************************************************
    change_shape_unlist=unlist(lapply(change_shape_zones, 
                                      function(l) l[[z]]))  
    change_scale_unlist=unlist(lapply(change_scale_zones, 
                                      function(l) l[[z]]))  
    change_n_unlist=unlist(lapply(change_n_zones, 
                                  function(l) l[[z]]))  
    change_qnt2yrs_unlist=unlist(lapply(change_qnt2yrs_zones,
                                        function(l) l[[z]]))
    
    change_shape_stdev_unlist=unlist(lapply(change_shape_stdev_zones, 
                                            function(l) l[[z]]))  
    change_scale_stdev_unlist=unlist(lapply(change_scale_stdev_zones, 
                                            function(l) l[[z]]))  
    change_n_stdev_unlist=unlist(lapply(change_n_stdev_zones,
                                        function(l) l[[z]]))
    change_qnt2yrs_stdev_unlist=unlist(lapply(change_qnt2yrs_stdev_zones,
                                              function(l) l[[z]]))
    
    df_changes_durat_zones[[z]]=data.frame(
      dur=c(1,2,3,4), 
    ...
    df_changes_durat_zones_merged=rbind(
       df_changes_durat_zones_merged,
       data.frame(dur=c(1,2,3,4), 
                  var_name=c(rep("Shape",4),
                             rep("Scale",4),
                             rep("n",4),
                             rep("qnt2yrs",4)),
  ...
  color.curves = c("shape"="black","scale"="red","n"="black","2yrs rt"="blue")
  
  plot_facets=ggplot(data=df_changes_durat_zones_merged_sort,
                     aes(x=dur,y=mean))+
    # geom_jitter() +
    theme_bw()+
    scale_x_continuous(expand=c(0,0),
    ...
    facet_wrap(~factor(reg_name,
                       levels=unique(df_changes_durat_zones_merged_sort$reg_name)),
    ...
    #geom_ribbon(aes(x=dur,ymin=mean-2*stdev, ymax=mean+2*stdev,
    #                fill=var_name), alpha=0.2)+
    #geom_ribbon(aes(x=dur,ymin=mean-stdev, ymax=mean+stdev, 
    #                fill=var_name), alpha=0.2)+
  ...
  ggsave(plot_facets, 
         filename=paste0(dir.res_maps_durat,
                         '/all_maps_changes_durat_',sat_prod,'_ZONES.png'),
         width=46,height=7,dpi=150,bg ="white")
  
  plot_facets_all=plot_grid(
    ggdraw()+draw_label(sat_acron,fontface='bold',x=0.5,hjust=0.5,vjust=0.5,size=30),
    plot_facets,
    labels=NULL,#c("","2yrs","scale","shape","n"),
    ncol=2,nrow=1,
    rel_widths=c(0.05,1),align='hv')
  ggsave(plot_facets_all, 
         filename=paste0(dir.res_maps_durat,
                         '/all_maps_changes_durat_',sat_prod,'_ZONES_bis.png'),
         width=46,height=7,dpi=150,bg="white")
  
  # plot_facets_all_zones=plot_grid(
  ...
  #        filename=paste0(dir.res_maps_durat, 
  #                        '/all_maps_changes_durat_',sat_prod,'_bis_ZONES.png'),
  ...
  numb_regions=20
  # Some modifications to df names (to have shorter names for the plot):
  test$reg_name[9]="E.R."
  test$reg_name[18]="F.V.G."
  test$reg_name[19]="Trentino A.A."
  message('Plotting merged results aggregating at admin. level (Regions)...')
  
  #^****************************************************************************  
  for (reg in 1:numb_regions){
  #^****************************************************************************
    change_shape_unlist=unlist(lapply(change_shape, 
                                      function(l) l[[reg]]))  
    change_scale_unlist=unlist(lapply(change_scale, 
                                      function(l) l[[reg]]))  
    change_qnt2yrs_unlist=unlist(lapply(change_qnt2yrs, 
                                        function(l) l[[reg]]))
    change_shape_stdev_unlist=unlist(lapply(change_shape_stdev, 
                                            function(l) l[[reg]]))  
    change_scale_stdev_unlist=unlist(lapply(change_scale_stdev, 
                                            function(l) l[[reg]]))  
    change_qnt2yrs_stdev_unlist=unlist(lapply(change_qnt2yrs_stdev, 
                                              function(l) l[[reg]]))
    ...
    df_changes_durat[[reg]]=data.frame(dur=c(1,2,3,4), 
                                       ...
                                       qnt2yrs_mean=change_qnt2yrs_unlist,
                                       qnt2yrs_sd  =change_qnt2yrs_stdev_unlist)
    df_changes_durat_merged=rbind(
       df_changes_durat_merged,
       data.frame(dur=c(1,2,3,4), 
                  var_name=c(rep("Shape",4),
                             rep("Scale",4), 
                             rep("qnt2yrs",4)),
    ...
    color.curves = c("shape"="black","scale"="red","2yrs rt"="blue")
  }
  ...
  ##############################################################################
  # plot only for 1 product but for all variables (scale, shape, qnt2yrs) +
  # + uncert (or not):
  plot_facets_reg =ggplot(data=df_changes_durat_merged, aes(x=dur,y=mean)) +
    ...
    scale_x_continuous(expand=c(0,0),name="Durations [h]",
                       ...
                       breaks=c(1,2,3,4),
                       limits=c(0.8,4.2))+
    scale_y_continuous(expand=c(0,0),name="Changes [%/decade]",
    ...
    theme(
      ...
      ,legend.position="right"
      ,legend.direction="vertical"
      ,strip.text=element_text(size=28,angle=90))
  ggsave(plot_facets_reg, 
         filename=paste0(dir.res_maps_durat,
                         '/all_maps_changes_durat_',sat_prod,'_reg.png'),
         width=46,height=7,dpi=200,bg="white")
  
  plot_facets_reg_all=plot_grid(
    ggdraw()+draw_label(sat_acron,fontface='bold',x=0.5,hjust=0.5,vjust=0.5,size=30),
    plot_facets_reg,
    labels=NULL,#c("","2yrs","scale","shape","n"),
    ncol=2,nrow=1,
    rel_widths=c(0.04,1),align='hv')
  ggsave(plot_facets_all, 
         filename=paste0(dir.res_maps_durat,
                         '/all_maps_changes_durat_',sat_prod,'_reg_ALL.png'),
         width=46,height=7,dpi=150,bg="white")
  
  
  # plot_facets_reg_all_all=plot_grid(
  #     plot_grid(ggdraw()+draw_label(sat_acron,fontface='bold',x=0.5,hjust=0.5,vjust=0.5,size=40),
  ...
  #                 ,axis.title.x=element_blank()
  #                 ,strip.text.x=element_text(size=40,angle=90)), 
  #               labels=NULL,ncol=2,nrow=1,rel_widths=c(0.07,1),align='hv'),
  #     plot_grid(ggdraw()+draw_label(sat_acron,fontface='bold',x=0.5,hjust=0.5,vjust=0.5,size=40),
  #               plot_facets_reg+theme(
  #                 #legend.position="none"
  #                 axis.title.y=element_blank()
  ...
  #                 ,strip.text.x=element_blank()),
  #               labels=NULL,#c("","2yrs","scale","shape","n"),
  #               ncol=2,nrow=1,rel_widths=c(0.07,1),align='hv'),
  #     plot_grid(ggdraw()+draw_label(sat_acron,fontface='bold',x=0.5,hjust=0.5,vjust=0.5,size=40),
  #               plot_facets_reg+theme(
  #                 #legend.position="none"
  #                 axis.title.y=element_blank()
  ...
  #        filename=paste0(dir.res_maps_durat,
  #                        '/all_maps_changes_durat_',sat_prod,'_reg_ALLALL.png'),
  ...
  if (flag.saveRDS){
  #^****************************************************************************
    # save results and plots into .rds file of changes per duration and per region:
